// src/components/InternLayout.jsx
import React, { useState } from 'react';
import { Link, useLocation, useNavigate } from 'react-router-dom';

const menuItems = [
    { path: '/intern/dashboard', label: 'Overview', icon: '📊' },
    { path: '/intern/profile', label: 'My Profile', icon: '👤' },
    { path: '/intern/tasks', label: 'Daily Tasks', icon: '📝' },
    { path: '/intern/reports', label: 'Progress Reports', icon: '📈' },
];
        ...
        <div className="min-h-screen bg-gray-50 flex font-inter">
            ...
            >
                ...
                <div className="absolute bottom-0 left-0 right-0 p-4 border-t border-gray-100">
                    {sidebarOpen && (
                        <div className="mb-3">
                            <p className="font-medium text-gray-900 truncate">{user.fullName || user.name || 'Intern'}</p>
